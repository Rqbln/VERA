# VERA governance policy (MVP4 gaas).
#
# Mirrors vera.governance.policy.builtin_decision so the OPA path and the in-process fallback agree.
# Query:  POST /v1/data/vera/governance/decision   with {"input": {...}}
# Input:  {model, mode, kill_switch, trust_score, signals}
# Result: {decision: "allow"|"flag"|"deny", reasons: [string], source: "opa"}
package vera.governance
