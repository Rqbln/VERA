...
from raip.api.auth import ROLE_COMPLIANCE, AuthUser, get_current_user, require_roles
from raip.schemas.declarative_forms import (
    FORM_IDS,
    FORM_META,
    DeclarativeFormBody,
    RedisFormStore,
...
def audit_pdf(
    ...
    from raip.governance.pdf_export import render_audit_pdf, weasyprint_available
    ...
    return Response(
        ...
        headers={"Content-Disposition": f'attachment; filename="raip_audit_{run_id[:8]}.pdf"'},
    )
