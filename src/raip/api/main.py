...
from raip.api.benchmark_registry import MVP1_PILOTE_REGISTRY
...
BENCHMARK_REGISTRY: list[dict[str, str]] = list(MVP1_PILOTE_REGISTRY)

app = FastAPI(title="RAIP MVP1 API", version="0.1.0")
