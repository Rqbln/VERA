...
from raip.api.auth import ROLE_DS, AuthUser, get_current_user, require_roles
from raip.config import get_settings
from raip.store.redis_models import RedisModelStore
...
def connected_models(
    ...
    target = settings.raip_target_model
