...
surfaced on the dashboard. This is a pragmatic, fully-local computation over scores RAIP already
...
def load_weights() -> dict[str, float]:
    """Weights from ``RAIP_TRUST_FACTOR_WEIGHTS`` (JSON) or the defaults, renormalised to sum 1."""
    raw = os.environ.get("RAIP_TRUST_FACTOR_WEIGHTS")
