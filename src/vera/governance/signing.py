...
def sign_artifact(payload: bytes | str | dict[str, Any]) -> dict[str, str]:
    ...
    key_id = settings.vera_signing_key_id
    algo = os.environ.get("VERA_SIGNING_ALGO", "sha256")
...
def image_digest_from_env() -> str:
    return os.environ.get("VERA_IMAGE_DIGEST", os.environ.get("IMAGE_DIGEST", "n/a"))
