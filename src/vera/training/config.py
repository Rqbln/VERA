...
class TrainingExperimentConfig:
    ...
    seed: int = 42
    clean_path: str = "minio://vera/datasets/clean"
    ...
    def from_dict(cls, data: dict[str, Any]) -> TrainingExperimentConfig:
        ...
        return cls(
            ...
            poison_enabled=bool(poison.get("enabled", cls.poison_enabled)),
            trigger_id=str(poison.get("trigger_id", cls.trigger_id)),
            poison_rate=float(poison.get("rate", cls.poison_rate)),
